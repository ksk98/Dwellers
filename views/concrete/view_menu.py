...
from views.concrete.view_multitoggle_test import ViewTest1
...
class ViewMenu(ViewBase):
    def __init__(self):
        ...
        self.options = [
            ...
            ["TEST", Views.TEST, lambda: context.GAME.view_manager.set_new_view_for_enum(Views.TEST, ViewTest1()), Input.SELECT],
